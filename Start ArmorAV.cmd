...
findstr /X /C:"4.2.3" "%~dp0artifacts\win-x64\cli\armorav-version.txt" >nul || goto BUILD_CLI
...
echo 4.2.3>"%~dp0artifacts\win-x64\cli\armorav-version.txt"
exit /b 0
...
findstr /X /C:"4.2.3" "%~dp0artifacts\win-x64\web\armorav-web-version.txt" >nul || goto BUILD_WEB
...
echo 4.2.3>"%~dp0artifacts\win-x64\web\armorav-web-version.txt"
exit /b 0
